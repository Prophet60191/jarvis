...
- **4GB RAM**: `qwen2.5:1.5b` or `llama3.2:1b`
- **8GB RAM**: `qwen2.5:7b` or `llama3.2:3b`
- **16GB+ RAM**: `qwen2.5:14b` or `llama3.1:8b`
...
- Read the [Configuration Guide](configuration.md) for detailed customization
- Check out [Usage Examples](../examples/) for common use cases
- Learn about [Tool Development](tools.md) to add custom functionality
